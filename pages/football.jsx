        ...
        <div className="lower">
          <div className="field">
            <div className="lineups">
              <div className="line1">
                <div className="circle" onClick={()=>{handleOpen(); getObj(8,'B')}}>
                  1
                </div>
              </div>
              <div className="line2">
                ...
                <div className="circle" onClick={()=>{handleOpen(); getObj(10,'A')}}>
                  6
                </div>
                <div className="circle" onClick={()=>{handleOpen(); getObj(8,'B')}}>7</div>
              </div>
              <div className="line3">
                <div className="circle" onClick={()=>{handleOpen(); getObj(8,'B')}}>10</div>
                <div className="circle" onClick={()=>{handleOpen(); getObj(8,'B')}}>11</div>
              </div>
              <div className="line4">
                <div className="circle" onClick={()=>{handleOpen(); getObj(8,'B')}}>11</div>
                <div className="circle" onClick={()=>{handleOpen(); getObj(8,'B')}}>10</div>
              ...
              <div className="line5">
                <div className="circle" onClick={()=>{handleOpen(); getObj(8,'B')}}>9</div>
                <div className="circle" onClick={()=>{handleOpen(); getObj(8,'B')}}>2</div>
                <div className="circle" onClick={()=>{handleOpen(); getObj(8,'B')}}>4</div>
              </div>
              <div className="line6" onClick={()=>{handleOpen(); getObj(8,'B')}}>
                <div className="circle" onClick={()=>{handleOpen(); getObj(8,'B')}}>1</div>
              </div>
            </div>
            <img
